...
export default function DesignServiceSection() {
  const items: ServiceItem[] = [
    {
      ...
      icon: <Layers className="h-5 w-5 text-[#485806]" />,
    },
    {
      ...
      icon: <LayoutGrid className="h-5 w-5 text-[#485806]" />,
    },
    {
      id: "srv-branding",
      title: "Branding",
      ...
      icon: <Sparkles className="h-5 w-5 text-[#485806]" />,
    },
    {
      id: "srv-deck-design",
      title: "Deck Design",
      ...
      icon: <Presentation className="h-5 w-5 text-[#485806]" />,
    },
    {
      id: "srv-ux-design",
      title: "UX Design",
      ...
      icon: <AppWindow className="h-5 w-5 text-[#485806]" />,
    },
    {
      ...
      icon: <PlayCircle className="h-5 w-5 text-[#485806]" />,
    },
  ];
  ...
  return (
    <section
      id="services-section"
      className="relative bg-[#F1F5E1] text-zinc-950 py-24 px-4 sm:px-6 lg:px-8 overflow-hidden border-b border-zinc-100"
    >
      <div className="relative w-full max-w-7xl mx-auto space-y-16">
        {/* Header Block */}
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          {/* Tag Pill */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5  bg-[#ffffff] border border-zinc-200/40 text-xs font-semibold text-zinc-700 tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {items.map((item, idx) => (
            <motion.div
              ...
              className="group flex flex-col justify-between bg-white rounded-md p-8  border border-zinc-100/50 hover:shadow-xl transition-all duration-300"
            >
              <div className="space-y-6">
                {/* Soft pink rounded container for icon */}
                <div className="flex items-center justify-center h-12 w-12  bg-brand-primary  transition-transform duration-300 group-hover:scale-105">
                  {item.icon}
                </div>

                {/* Text Block */}
                <div className="space-y-3">
                  <h3 className="text-xl sm:text-2xl font-manrop font-medium text-[#362c0b] ">
                    {item.title}
                  </h3>
